      ...
      if(filter_var($email, FILTER_VALIDATE_EMAIL)){//if email is valid
         ...
         if(mysqli_num_rows($sql) > 0){ //if email already exist
            ...
            if(isset($_FILES['image'])){ //if file is uploaded
               ...
               //let's explode image and get the last extension link hpg jpeg png
               ...
               if(in_array($img_ext, $extensions) === true){ //if user uploaded img ext is matched with any array extentions
                  ...
                  // let's move the user uploaded img our particular folder
                  ...
                  echo "Pleses select an Image file - jpeg, jpg, png!";
               }
            }else{
